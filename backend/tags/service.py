...
class TagService:
    ...
    def get_tag_by_id(self, tag_id: int, current_user: User) -> Tag:
    ...
    def update_tag(self, tag_data: TagUpdate, current_user: User) -> Tag:
        tag = self.get_tag_by_id(tag_data.id, current_user)
